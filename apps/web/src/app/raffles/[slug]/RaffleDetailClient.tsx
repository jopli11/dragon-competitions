              ...
              <GlassCard className="p-8 text-center border-amber-500/20 bg-amber-50">
                ...
                <div className="mt-6">
                  ...
                  <SocialLinks
                    ...
                    wrapperClassName="flex h-10 w-10 items-center justify-center rounded-full bg-amber-100 text-amber-700 transition-colors hover:bg-amber-500 hover:text-white"
                  />
                </div>
              </GlassCard>
            ) : isEnded ? (
