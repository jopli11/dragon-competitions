        ...
        <div className="max-w-3xl mx-auto mt-16 sm:mt-24">
          <div className="bg-white rounded-4xl sm:rounded-[3.5rem] border border-brand-primary/5 shadow-xl p-8 sm:p-16">
            ...
            <p className="text-brand-midnight/70 leading-relaxed font-medium mb-6">
              These terms and conditions govern your use of Coast Competitions. By accessing or using our website, you agree to be bound by these terms. If you do not agree with any part of these terms, you must not use our services.
            </p>
            ...
            <p className="text-brand-midnight/70 leading-relaxed font-medium mb-4">
              To enter any competition on Coast Competitions, you must:
            </p>
            ...
            <p className="text-brand-midnight/70 leading-relaxed font-medium mb-6">
              Coast Competitions operates a strict "No Extensions" policy. Every competition will close and the draw will take place on the specified date, regardless of the number of tickets sold.
            </p>
          </div>
        </div>
      </Container>
