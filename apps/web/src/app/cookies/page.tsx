          ...
          <div className="bg-white rounded-4xl sm:rounded-[3.5rem] border border-brand-primary/5 shadow-xl p-8 sm:p-16 space-y-12">
            ...
            <section>
              ...
              <p className="text-brand-midnight/70 leading-relaxed font-medium mb-4">
                We do not use non-essential cookies. The only cookies or storage mechanisms we use are:
              </p>
              <ul className="list-disc pl-6 space-y-3 text-brand-midnight/70 font-medium">
                <li><strong>Essential Cookies:</strong> Necessary for the website to function, such as maintaining your authentication session and security.</li>
                <li><strong>Privacy-First Analytics:</strong> We use <a href="https://www.crumbless.io" className="text-brand-primary underline">Crumbless</a> for web analytics. Crumbless is a privacy-first, zero-cookie analytics provider that does not track individual users across sites or store personal data.</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p className="text-brand-midnight/70 leading-relaxed font-medium">
                Because we do not use non-essential cookies, you do not need to manage consent preferences on our site. However, most web browsers allow some control of most cookies through the browser settings. To find out more about cookies, including how to see what cookies have been set, visit <a href="https://www.aboutcookies.org" className="text-brand-primary underline">www.aboutcookies.org</a>.
              </p>
            </section>
